 ...
 * @author epda
 */
public class AvisoBorrarA extends javax.swing.JInternalFrame {

    public static int id;
    /**
     * Creates new form AvisoBorrarA
     */
    public AvisoBorrarA() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Deseas borrar este alojamiento?");
...
Alojamiento a = new Alojamiento();
        ...
        try {
          ...
          AlojamientoData cd = new AlojamientoData(conexion);         
        
            a.setId(id);
         cd.borrarAlojamiento(a); 
